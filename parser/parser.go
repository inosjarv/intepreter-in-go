...
func (p *Parser) parsePrefixExpression() ast.Expression {
	...
	expression.Right = p.parseExpression(PRFIX)
	return expression
}
...
func (p *Parser) parseCallExpression(funciton ast.Expression) ast.Expression {
	exp := &ast.CallExpression{Token: p.curToken, Function: funciton}
