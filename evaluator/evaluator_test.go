	...
	for _, tt := range tests {
		...
		if errorObj.Message != tt.expectedMessage {
			t.Errorf("wrong error message. expected=%q, got=%q, input %s\n",
				tt.expectedMessage, errorObj.Message, tt.input)
		}
	}
}
...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if result.Value != expected {
		t.Errorf("object is not Integer. got %T, expected %d", result.Value, expected)
		return false
	}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if result.Value != expected {
		t.Errorf("object is not Integer. got %t, expected %t", result.Value, expected)
		return false
	}
